    ...
    <div class="container">
        <div class="row justify-content-center">
            <form class="form-inline">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn add-modal" style="font-size:18px;color:grey" type="submit"><i class="fa fa-plus"></i> New Folder</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <ul>
                        ...
                        <!-- <a href="#" class="add-modal"><li>New Folder</li></a>
                        <a href="#" class="add-modal"><li>Upload</li></a> -->
    ...
    <div id="deleteModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="text-center">Are you sure you want to delete this file?</h3>
                    <br />
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="title">Folder Name</label>
                            <div class="col-sm-10">
